...
describe('Fahrzeug Versichert Werden Page - Negative UI Test (DE)', () => {
    ...
    it('Verify all elements visibility and feedback messages on (DE) language on "Fahrzeug Versichert Werden" page', () => {
